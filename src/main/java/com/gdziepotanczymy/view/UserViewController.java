...
public class UserViewController {
    ...
    public ModelAndView displayCreateUserForm() {
        ...
        ModelAndView modelAndView = new ModelAndView("create_user_form");
        modelAndView.addObject("createUpdateUserDto", createUpdateUserDto);

        return modelAndView;
    }

    @PostMapping("/new-user")
    public String createUser(@ModelAttribute CreateUpdateUserDto createUpdateUserDto) throws AlreadyExists, BadRequest {
